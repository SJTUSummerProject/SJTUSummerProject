...
url = "https://search.damai.cn/search.htm?spm=a2oeg.home.category.ditem_0.591b48d36pAKmR&ctl=%E6%BC%94%E5%94%B1%E4%BC%9A&order=1&cty=%E5%8C%97%E4%BA%AC"
html = urlopen(url)
bsObj = BeautifulSoup(html, 'html.parser')
page_num_text = bsObj.findAll("ul", {"class":"search-page-num"})[0].get_text()
# page_num_text = bsObj.findAll("span", {"class": "cf"})[0].get_text()
